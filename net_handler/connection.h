...
/**
 * Start the main connection control thread. Does not block.
 ...
 */
void start_conn(robot_desc_field_t client, int connfd, int send_logs);

/**
 * Stops the connection control thread cleanly. May block briefly to allow
